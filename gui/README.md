...
The ZUPT GUI is a Python/Qt front end for the ZUPT 5.2.6 command-line
...
- `zupt-gui_5.2.6_all.deb`;
- `zupt-gui-5.2.6-1.noarch.rpm`;
- `zupt-gui-5.2.6-1.src.rpm`;
- `zupt-gui-5.2.6-portable.zip`.
...
not promoted by the upstream 5.2.6 release gates.
...
not make the untested GUI installer a 5.2.6 release asset. The promoted Windows
